...
export default function Projects_() {
  return (
    <div className="container mb-32 max-w-[1200px] mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      {/* Project Cards */}
      ...
      <div className="card-content  rounded-lg flex flex-col justify-between">
        ...
        <div className="flex flex-col p-4">
          ...
          <p className="text-slate-500">
            Mini CRUD app for managing employee information.
          </p>
        </div>
      </div>
